...
if (isset($_GET['edit_product'])) {
    ...
    if (isset($_POST['update_product'])) {
        ...
        if (empty($updated_product_image1)) {
            $updated_product_image1 = $product_img1;
        }
        if (empty($updated_product_image2)) {
            $updated_product_image2 = $product_img2;
        }
        if (empty($updated_product_image3)) {
            $updated_product_image3 = $product_img3;
        }
...
<div class="container mt-3">
    ...
    <form action="" method="post" enctype="multipart/form-data" class="text-center">
        ...
        <div class="form-outline mb-4 w-50 m-auto">
            ...
            <input type="text" name="product_title" id="product_title" class="form-control" placeholder="Enter product title" value="<?php echo $product_title ?>" autocomplete="false">
        </div>

        <!-- description -->
        <div class="form-outline mb-4 w-50 m-auto">
            <label for="description" class="form-label">Description</label>
            <input type="text" name="description" id="description" class="form-control" placeholder="Enter product description" value="<?php echo $description ?>" autocomplete="false">
        </div>
        ...
        <div class="form-outline mb-4 w-50 m-auto d-flex">
            <input type="file" name="product_image1" id="product_image1" class="form-control m-auto">
        ...
        <div class="form-outline mb-4 w-50 m-auto">
            ...
            <input type="text" name="product_price" id="product_price" class="form-control" placeholder="Enter product price" value="<?php echo $product_price ?>" autocomplete="false">
        </div>
