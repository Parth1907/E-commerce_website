                ...
                <div class='col-md-4 mb-2'>
                    <div class='card' style='width: 18rem; height: 25rem; margin-left: 12.5%'>
                        ...
                        <div class='card-body'>
                            ...
                            <p class='card-text' id='product-text'>$product_description</p>
...
function search_product()
{
    ...
    if (isset($_GET['search_data_product'])) {
        ...
        $num_of_rows = mysqli_num_rows($result_query);
        if ($num_of_rows == 0) {
            echo "<h2 class='text-center text-danger'>No products found for given keyword.</h2>";
        }
        while ($row = mysqli_fetch_assoc($result_query)) {
            $product_id = $row['product_id'];
            $product_title = $row['product_title'];
        ...
        if (!isset($_GET['category'])) {
            if (!isset($_GET['brand'])) {
                ...
                while ($row = mysqli_fetch_assoc($result_query)) {
                    ...
                    <div class='col-md-8'>
                        <!-- More info on selected product -->
                        <div class='row'>
                            <div class='col-md-12'>
                                <h4 class='text-center text-info mb-5'>Some more product images</h4>
                            </div>
                            <div class='col-md-6'>
...
function cart()
{
    if (isset($_GET['add_to_cart'])) {
        ...
        if ($num_of_rows > 0) {
            ...
            echo "<script>alert('Item succesfully added in cart')</script>";
            echo "<script>window.open('index.php','_self')</script>";
        }
    }
}

// showing no.of item in cart function
...
function totalCartPrice()
{
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        while ($row_product_price = mysqli_fetch_array($result_products)) {
            $product_price = array($row_product_price['product_price']);  // makes an array of all the prices
            $product_values = array_sum($product_price); // sums up all the values in the array
            ...
            if (!isset($_GET['my_orders'])) {
                if (!isset($_GET['delete_account'])) {
                    ...
                    if($row_count>0) {
                        ...
                        echo "<h3 class='text-center text-success mt-5'>You have <span class='text-danger'> 0 </span>pending orders</h3> 
